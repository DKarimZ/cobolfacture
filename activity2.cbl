       ...
       01  SQL-UPDATE-LINE.
        ...
        SCREEN SECTION.
         ...
         01 MAIN-FUNCTION-SCREEN.
           ...
           05 FILLER LINE 30 COLUMN 1    
           VALUE "F6 - faire un achat chez un partenaire"
           FOREGROUND-COLOR COB-COLOR-GREEN.

           05 FILLER LINE 35 COLUMN 1    
...
*
       ...
       0100-MAIN-PROCEDURE.
           ...
           and wColR <= 70)
           PERFORM 0220-OPPOSITION.

           if(wRowR >=13 and wRowR <= 17) and (wColR >= 0 
           and wColR <= 70)
           PERFORM 0240-ACHAT-PART.

           if(wRowR >=31 and wRowR <= 39) and (wColR >= 0 
           and wColR <= 70)
      ...
      *     END-EVALUATE.
       ...
       0200-CREDITER-CC.
           ...
           IF(SOMMEEPARGNEE IS NUMERIC)
               STRING '-' SOMMEEPARGNEE DELIMITED BY SIZE 
               INTO DET-MONTANT
       ...
       0220-OPPOSITION.
           ...
           DISPLAY HEADER-SCREEN.
           DISPLAY OPPOSITION-SCREEN.
           ACCEPT OPPOSITION-SCREEN.
           ...
           END-IF.
              ...
              ("YYYY-MM-DD" WS-DATE ) TO WS-DATE2.
              MOVE WS-DATE2 TO DET-DATEOP.

              EVALUATE TRUE 
                  WHEN V-FNC-F1 
               MOVE 'OPPOSITION CHEQUE BANQUE' TO C-TYPEOP
               MOVE "opposition sur chèque prise en compte" TO WSMSG
       ...
       0240-ACHAT-PART.
           ...
           DISPLAY HEADER-SCREEN.
           DISPLAY ACHAT-CHEZ-PARTNER-SCREEN.
           ACCEPT ACHAT-CHEZ-PARTNER-SCREEN.
